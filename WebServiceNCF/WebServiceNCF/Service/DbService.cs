...
namespace WebServiceNCF.Service
{
    public class DbService
    {
        ...
        /// 
        /// </summary>
        public static ResponseMsg executeTransactionReserva(String TipoSecuencia, String Sistema, String NumeroFactura)
        {
            ResponseMsg rs = null;
            ...
            try
            {
                ...
                using (SqlConnection connetion = new SqlConnection(ConnectionString))
                {
                    ...
                    using (SqlCommand _DbCommand = new SqlCommand())
                    {
                        ...
                        _DbCommand.CommandText = "dbo.udfGetReservaSecuenciaNCF";
        ...
        /// 
        /// </summary>
        public static ResponseMsgReserva executeTransactionGeneraReserva(String TipoSecuencia, int Cantidad)
        {
            ResponseMsgReserva rs = null;
            ...
            try
            {
                ...
                using (SqlConnection connetion = new SqlConnection(ConnectionString))
                {
                    ...
                    using (SqlCommand _DbCommand = new SqlCommand())
                    {
                        ...
                        _DbCommand.CommandText = "dbo.udfGeneraReservaSecuenciaNCF";

                        _DbCommand.Parameters.Add(new SqlParameter() { ParameterName = "@cantidad", SqlDbType = SqlDbType.Int, Value = Cantidad });

                        _DbCommand.Parameters.Add(new SqlParameter() { ParameterName = "@tipo_comprobante", SqlDbType = SqlDbType.VarChar, Value = TipoSecuencia });

                        _DbCommand.ExecuteNonQuery();

                        rs = new ResponseMsgReserva() { Status = "1", Mensaje = "La Reserva fue creada correctamente!!!" };
